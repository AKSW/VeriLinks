		...
		if (ServletFileUpload.isMultipartContent(req)) {
			...
			try {
				...
				for (FileItem fileItem : items) {
					...
					// first
					if (itemName.equals(AdminPanel.NAME))
						name = fileItem.getString();
					if (itemName.equals(AdminPanel.ENDPOINT))
						endpoint = fileItem.getString();
					if (itemName.equals(AdminPanel.PROP0))
						prop0 = fileItem.getString();
					if (itemName.equals(AdminPanel.PROP1))
						prop1 = fileItem.getString();
					if (itemName.equals(AdminPanel.PROP2))
						prop2 = fileItem.getString();
					if (itemName.equals(AdminPanel.PROP3))
						prop3 = fileItem.getString();
					if (itemName.equals(AdminPanel.IMAGE))
						image = fileItem.getString();
					if (itemName.equals(AdminPanel.TYPE))
						type = fileItem.getString();

					// second
					if (itemName.equals(AdminPanel.NAME_2))
						name_2 = fileItem.getString();
					if (itemName.equals(AdminPanel.ENDPOINT_2))
						endpoint_2 = fileItem.getString();
					if (itemName.equals(AdminPanel.PROP0_2))
						prop0_2 = fileItem.getString();
					if (itemName.equals(AdminPanel.PROP1_2))
						prop1_2 = fileItem.getString();
					if (itemName.equals(AdminPanel.PROP2_2))
						prop2_2 = fileItem.getString();
					if (itemName.equals(AdminPanel.PROP3_2))
						prop3_2 = fileItem.getString();
					if (itemName.equals(AdminPanel.IMAGE_2))
						image_2 = fileItem.getString();
					if (itemName.equals(AdminPanel.TYPE_2))
						type_2 = fileItem.getString();

					if (itemName.equals(AdminPanel.DIFFICULTY))
						difficulty = fileItem.getString();
					if (itemName.equals(AdminPanel.PREDICATE))
						predicate = fileItem.getString();
					if (itemName.equals(AdminPanel.DESCRIPTION))
						description = fileItem.getString();
					if (itemName.equals(AdminPanel.LINKSET))

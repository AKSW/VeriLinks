...
package org.aksw.verilinks.games.peaInvasion.client.oauth;
...
class CookieStoreImpl extends TokenStoreImpl {
  ...
  public native void set(String key, String value) /*-{
    $doc.cookie = @org.aksw.verilinks.games.peaInvasion.client.oauth.CookieStoreImpl::COOKIE_PREFIX +
        encodeURIComponent(name) + '=' + encodeURIComponent(value);
  }-*/;

  @Override
  public native String get(String key) /*-{
    var m = @org.aksw.verilinks.games.peaInvasion.client.oauth.CookieStoreImpl::ensureCookies();
    return m[@org.aksw.verilinks.games.peaInvasion.client.oauth.CookieStoreImpl::COOKIE_PREFIX + key];
  }-*/;

  @Override
  public native void clear() /*-{
    $doc.cookie = null;
    @org.aksw.verilinks.games.peaInvasion.client.oauth.CookieStoreImpl::cachedCookies = null;
  }-*/;
  ...
  private static native void loadCookies() /*-{
    @org.aksw.verilinks.games.peaInvasion.client.oauth.CookieStoreImpl::cachedCookies = {};
    ...
    if (docCookie && docCookie != '') {
      ...
      for ( var i = 0; i < crumbs.length; ++i) {
        ...
        @org.aksw.verilinks.games.peaInvasion.client.oauth.CookieStoreImpl::cachedCookies[name] = value;
      }
    }
  }-*/;

...
public abstract class Auth {
  ...
  public static native void export() /*-{
    ...
    $wnd.oauth2.login = $entry(function(req, success, failure) {
      @org.aksw.verilinks.games.peaInvasion.client.oauth.Auth::nativeLogin(*)(req, success, failure);
    });

    $wnd.oauth2.expiresIn = $entry(function(req) {
      return @org.aksw.verilinks.games.peaInvasion.client.oauth.Auth::nativeExpiresIn(*)(req);
    });
  }-*/;
